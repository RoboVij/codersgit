...
const headCells = [
  ...
  { id: "pushed_at", numeric: true, disablePadding: false, label: "Pushed at" },
  { id: "open_issues", numeric: true, disablePadding: false, label: "Issues" },
  { id: "forks", numeric: true, disablePadding: false, label: "Forks" },
  { id: "watchers", numeric: true, disablePadding: false, label: "Stars" },
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        {dateFormat(row.created_at, "mmm d, yyyy")}
                      </TableCell>
                      <TableCell align="right">
                        {dateFormat(row.pushed_at, "mmm d, yyyy")}
                      </TableCell>
